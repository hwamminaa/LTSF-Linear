...
if __name__ == '__main__':
    ...
    # data loader
    parser.add_argument('--data', type=str, required=False, default='m2_recipe8', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./rtf_data/m2_recipe8/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='m2_r8_rtf_0.csv', help='data file')
    ...
    parser.add_argument('--enc_in', type=int, default=228, help='encoder input size') # DLinear with --individual, use this hyperparameter as the number of channels
